...
const BAZAAR_ACCEPT_SCHEMA: Record<string, { info: unknown; schema: unknown }> = {
  ...
  "/api/v1/coding/cache/dependency-tree":     { info: { input: { type: "http", method: "POST" },inputSchema: { type: "object", required: ["code"], properties: { code: { type: "string" }, filename: { type: "string" } } } },                                        schema: { type: "object", required: ["code"], properties: { code: { type: "string" }, filename: { type: "string" } } } },
  "/api/v1/coding/cache/token-compressor":    { info: { input: { type: "http", method: "POST" },inputSchema: { type: "object", required: ["raw_code"], properties: { raw_code: { type: "string" } } } },                                                               schema: { type: "object", required: ["raw_code"], properties: { raw_code: { type: "string" } } } },
  "/api/v1/coding/cache/syntax-heartbeat":    { info: { input: { type: "http", method: "POST" },inputSchema: { type: "object", required: ["code"], properties: { code: { type: "string" } } } },                                                                      schema: { type: "object", required: ["code"], properties: { code: { type: "string" } } } },
  "/api/v1/coding/cache/refactor-suggest":    { info: { input: { type: "http", method: "POST" },inputSchema: { type: "object", required: ["code"], properties: { code: { type: "string" }, language: { type: "string" } } } },                                        schema: { type: "object", required: ["code"], properties: { code: { type: "string" }, language: { type: "string" } } } },
  "/api/v1/coding/cache/security-audit":      { info: { input: { type: "http", method: "POST" },inputSchema: { type: "object", required: ["code"], properties: { code: { type: "string" }, language: { type: "string" } } } },                                        schema: { type: "object", required: ["code"], properties: { code: { type: "string" }, language: { type: "string" } } } },
  "/api/v1/analysis/memory/heartbeat":        { info: { input: { type: "http", method: "POST" },inputSchema: { type: "object", required: ["text_a", "text_b"], properties: { text_a: { type: "string" }, text_b: { type: "string" } } } },                            schema: { type: "object", required: ["text_a", "text_b"], properties: { text_a: { type: "string" }, text_b: { type: "string" } } } },
  "/api/v1/analysis/memory/entity-extractor": { info: { input: { type: "http", method: "POST" },inputSchema: { type: "object", required: ["text"], properties: { text: { type: "string" } } } },                                                                      schema: { type: "object", required: ["text"], properties: { text: { type: "string" } } } },
  "/api/v1/analysis/memory/context-ranker":   { info: { input: { type: "http", method: "POST" },inputSchema: { type: "object", required: ["query", "chunks"], properties: { query: { type: "string" }, chunks: { type: "array", items: { type: "string" } } } } },    schema: { type: "object", required: ["query", "chunks"], properties: { query: { type: "string" }, chunks: { type: "array", items: { type: "string" } } } } },
  "/api/v1/analysis/memory/bias-detector":    { info: { input: { type: "http", method: "POST" },inputSchema: { type: "object", required: ["text"], properties: { text: { type: "string" } } } },                                                                      schema: { type: "object", required: ["text"], properties: { text: { type: "string" } } } },
  "/api/v1/analysis/memory/fact-linkage":     { info: { input: { type: "http", method: "POST" },inputSchema: { type: "object", required: ["claim"], properties: { claim: { type: "string" }, language: { type: "string" } } } },                                      schema: { type: "object", required: ["claim"], properties: { claim: { type: "string" }, language: { type: "string" } } } },
};
