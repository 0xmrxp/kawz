...
// x402 v2 spec: extensions is top-level on PaymentRequired, not per-accept item.
// x402scan reads extensions.bazaar.info.inputSchema from the live 402 challenge.
// @x402/hono validates routeConfig.extensions.bazaar must have { info, schema } shape.
const BAZAAR_ACCEPT_SCHEMA: Record<string, { info: unknown; schema: unknown }> = {
  "/api/v1/trading/engine/vitals":            { info: { inputSchema: { type: "object", properties: {} } },                                                                                                                    schema: { type: "object", properties: {} } },
  "/api/v1/trading/engine/orderbook-depth":   { info: { inputSchema: { type: "object", properties: { pair: { type: "string", description: "Trading pair, default BTC/USDT" } } } },                                           schema: { type: "object", properties: { pair: { type: "string" } } } },
  "/api/v1/trading/engine/mev-risk-index":    { info: { inputSchema: { type: "object", properties: {} } },                                                                                                                    schema: { type: "object", properties: {} } },
  "/api/v1/trading/engine/funding-rates":     { info: { inputSchema: { type: "object", properties: {} } },                                                                                                                    schema: { type: "object", properties: {} } },
  "/api/v1/trading/engine/whale-tracker":     { info: { inputSchema: { type: "object", properties: {} } },                                                                                                                    schema: { type: "object", properties: {} } },
  "/api/v1/coding/cache/dependency-tree":     { info: { inputSchema: { type: "object", required: ["code"], properties: { code: { type: "string" }, filename: { type: "string" } } } },                                        schema: { type: "object", required: ["code"], properties: { code: { type: "string" }, filename: { type: "string" } } } },
  "/api/v1/coding/cache/token-compressor":    { info: { inputSchema: { type: "object", required: ["raw_code"], properties: { raw_code: { type: "string" } } } },                                                               schema: { type: "object", required: ["raw_code"], properties: { raw_code: { type: "string" } } } },
  "/api/v1/coding/cache/syntax-heartbeat":    { info: { inputSchema: { type: "object", required: ["code"], properties: { code: { type: "string" } } } },                                                                      schema: { type: "object", required: ["code"], properties: { code: { type: "string" } } } },
  "/api/v1/coding/cache/refactor-suggest":    { info: { inputSchema: { type: "object", required: ["code"], properties: { code: { type: "string" }, language: { type: "string" } } } },                                        schema: { type: "object", required: ["code"], properties: { code: { type: "string" }, language: { type: "string" } } } },
  "/api/v1/coding/cache/security-audit":      { info: { inputSchema: { type: "object", required: ["code"], properties: { code: { type: "string" }, language: { type: "string" } } } },                                        schema: { type: "object", required: ["code"], properties: { code: { type: "string" }, language: { type: "string" } } } },
  "/api/v1/analysis/memory/heartbeat":        { info: { inputSchema: { type: "object", required: ["text_a", "text_b"], properties: { text_a: { type: "string" }, text_b: { type: "string" } } } },                            schema: { type: "object", required: ["text_a", "text_b"], properties: { text_a: { type: "string" }, text_b: { type: "string" } } } },
  "/api/v1/analysis/memory/entity-extractor": { info: { inputSchema: { type: "object", required: ["text"], properties: { text: { type: "string" } } } },                                                                      schema: { type: "object", required: ["text"], properties: { text: { type: "string" } } } },
  "/api/v1/analysis/memory/context-ranker":   { info: { inputSchema: { type: "object", required: ["query", "chunks"], properties: { query: { type: "string" }, chunks: { type: "array", items: { type: "string" } } } } },    schema: { type: "object", required: ["query", "chunks"], properties: { query: { type: "string" }, chunks: { type: "array", items: { type: "string" } } } } },
  "/api/v1/analysis/memory/bias-detector":    { info: { inputSchema: { type: "object", required: ["text"], properties: { text: { type: "string" } } } },                                                                      schema: { type: "object", required: ["text"], properties: { text: { type: "string" } } } },
  "/api/v1/analysis/memory/fact-linkage":     { info: { inputSchema: { type: "object", required: ["claim"], properties: { claim: { type: "string" }, language: { type: "string" } } } },                                      schema: { type: "object", required: ["claim"], properties: { claim: { type: "string" }, language: { type: "string" } } } },
};
